...
export declare const splitArrayIntoBatches: (
  arr: any[],
  batchSize: number
) => any[];
export declare const getImageTransform: (
...
export declare const getImageTranslate: (
  image: Dimensions,
  screen: Dimensions
) => Position;
export declare const getImageDimensionsByTranslate: (
  translate: Position,
  screen: Dimensions
) => Dimensions;
export declare const getImageTranslateForScale: (
...
export declare const createPanResponder: ({
  onGrant,
  onStart,
  onMove,
  onRelease,
...
export declare const getDistanceBetweenTouches: (
